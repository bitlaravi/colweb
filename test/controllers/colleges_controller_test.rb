...
class CollegesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create college" do
    assert_difference('College.count') do
      post colleges_url, params: { college: { college_code: @college.college_code, college_name: @college.college_name, college_type: @college.college_type, location: @college.location, university: @college.university } }
    end
  ...
  test "should update college" do
    patch college_url(@college), params: { college: { college_code: @college.college_code, college_name: @college.college_name, college_type: @college.college_type, location: @college.location, university: @college.university } }
